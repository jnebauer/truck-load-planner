...
import { BarChart3, Truck, Package, ExternalLink } from 'lucide-react';
...
export default function AppCard({ app }: AppCardProps) {
  ...
  const IconComponent = iconMap[uiMetadata.icon as keyof typeof iconMap] || Package;
